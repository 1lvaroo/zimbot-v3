...
// Other
global.owner = ['212693562443',212777466518']
global.premium = ['212713685000','212777466518']
global.botname = 'alvaro_losinda'
...
global.mess = {
    success: '*success whoa*',
        ban: '*نوض تقود راك مباني   كتب .owner باش نحيدلك البان*',
    horny: '*nsfw is disabled please ask owner to enable it*',
    admin: '*غي المقود لي يكتب هاد الامر*',
    botAdmin: '*with due respect can you please give bot adminship*',
    owner: '*غي المقود لي يكتب هاد امر*',
    ...
    endLimit: '*قويتي باراك عليك .buy limit amount limit to buy limit, Note: Limit will be reset every 12 hours*',
}
global.limitawal = {
    premium: "Infinity",
    free: 25
